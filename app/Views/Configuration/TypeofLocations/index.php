...
<div class="section">
    <h4 class="header">TYPE OF LOCATION</h4>
    <div class="divider"></div>
    <div class="row">
        <div class="col s12 m12 l2">
            <a href="<?= $newRecord ?>" class="btn blue"><i class="mdi-content-add"></i> Add Location Type</a>
        </div>
        <div class="col s12 m12 l2">
    ...
    <div class="row">
        <div class="col s12 m12 l12">
            <table id="location-type-table" class="responsive-table bordered">
                <thead>
                    <tr>
                ...
                <tbody>
                    <?php foreach ($locationTypeRecord as $item) : ?>
                        <tr id="<?= $item->id ?>">
                            <td><?= $recordNumber ?></td>
                            <td><?= $item->name ?></td>
                            <td>
            ...
            <?= $pager->links('location_type', 'data_table') ?>
        </div>
    </div>
</div>
<?= $this->endSection() ?>
