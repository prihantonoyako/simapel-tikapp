...
<div class="section">
    ...
    <div class="row">
        <div class="col s12 m12 l12">
            <table id="subdistrict-table" class="responsive-table bordered">
                <thead>
                    <tr>
                        <th data-field="index">No</th>
                        <th data-field="name">Name</th>
                        <th data-field="subdistrict">Sub-District</th>
                ...
                <tbody>
                    <?php foreach ($subdistricts as $subdistrict) : ?>
                        <tr id="<?= $subdistrict->id ?>">
                            <td><?= $recordNumber ?></td>
                            <td><?= $subdistrict->name ?></td>
                            <td><?= $subdistrict->district ?></td>
                            <td><?= $subdistrict->city ?></td>                            
                            <td><?= $subdistrict->province ?></td>
                            <td>
                                <a href="#" class="btn red remove-record"><i class="mdi-action-delete"></i></a>
                                <a href="<?= $editRecord . "/" . $subdistrict->id ?>" class="btn blue"><i class="mdi-editor-mode-edit"></i></a>
                            </td>
                        </tr>
                        <?php $recordNumber++ ?>
                    <?php endforeach; ?>
            ...
            <?= $pager->links('subdistrict', 'data_table') ?>
        </div>
    </div>
</div>
<?= $this->endSection() ?>
