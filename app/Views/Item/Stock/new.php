					...
					<?= csrf_field() ?>
						...
						<div class="row">
							<div class="input-field col s6">
								<input name="vendor" id="vendor" value="<?= old('vendor') ?>" type="text" list="vendors">
							...
							<div class="input-field col s6">
								<input name="is_bts" id="is_bts" type="checkbox">
						...
						<div class="row">
							<div class="input-field col s12">
								...
								<input name="quantity" id="quantity" min=0 value="<?= old('quantity') ?>" type="number">
							</div>
						</div>
						<div class="row">
							<div class="input-field col s12">
