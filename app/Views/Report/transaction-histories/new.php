					...
					<form class="col s12" method="POST" action="<?= $url_action ?>">
						...
						<div class="row">
							...
							<div class="input-field col s12 m12 l6">
								<input id="category" name="category" value="<?= old('category') ?>" list="categories" type="text">
						...
						<div class="row">
							<div class="input-field col s12 m12 l12">
								<input id="ammount" name="ammount" value="<?= old('ammount') ?>" type="number" min="0">
								<label for="ammount">Ammount</label>
							</div>
							<div class="input-field col s12 m12 l12">
								<input id="date" class="datepicker" name="date" value="<?= old('date') ?>" type="date">
