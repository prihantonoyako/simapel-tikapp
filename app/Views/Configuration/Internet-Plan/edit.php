					...
					<form class="col s12" method="POST" action="<?= $url_action ?>">
						...
						<div class="row">
							<div class="input-field col s12">
								<input id="name" value="<?= $internetPlan->name ?>" name="name" type="text">
								<label for="name">Name</label>
							</div>
						</div>
						<div class="row">
							<div class="input-field col s9">
								<input id="download" value="<?= $internetPlan->download ?>" name="download" type="number" min="0">
								<label for="download">Download</label>
							</div>
							<div class="input-field col s3">
								<input id="download_unit" value="<?= $internetPlan->download_unit ?>" name="download_unit" type="text">
								<label for="download_unit">Unit</label>
							</div>
						</div>
						<div class="row">
							<div class="input-field col s9">
								<input id="upload" value="<?= $internetPlan->upload ?>" name="upload" type="number" min="0">
								<label for="upload">Upload</label>
							</div>
							<div class="input-field col s3">
								<input id="upload_unit" value="<?= $internetPlan->upload_unit ?>" name="upload_unit" type="text">
								<label for="upload_unit">Unit</label>
							</div>
						</div>
						<div class="row">
							<div class="input-field col s12">
								<input id="price" value="<?= $internetPlan->price ?>" name="price" type="text">
								<label for="price">Price</label>
							</div>
						</div>
						<div class="row">
							<div class="input-field col s12 m12 l2">
								<?php if(intval($internetPlan->dedicated)==1): ?>
									<input type="checkbox" name="dedicated" id="dedicated" checked>
								<?php else: ?>
									<input type="checkbox" name="dedicated" id="dedicated" checked>
								<?php endif; ?>
