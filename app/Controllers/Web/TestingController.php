...
class TestingController extends BaseController
{
	...
	{
                try {
                        $client = new RouterOS\Client('10.222.2.2', 'admin', 'kokon');
                        echo 'OK';
                } catch (\Exception $e) {
                        die($e);
                }
                // $barangMo = new BarangModel;
                // $barang = $barangMo->where('id_vendor','1')->findAll();
                // dd($barang);
                // $vendorModel = new VendorModel;
                // $vendor = $vendorModel->find('1');
                // dd($vendor);
			// $barang = $vendorModel->builder()
			// ->join('barang', 'barang.id_vendor = vendor.id_vendor')
			// ->get()->getResultArray();
                        // dd($barang);
		// $provinsis = $this->getkota();
		// foreach($provinsis as $provinsi=>$kotas){
		// 	$provModel = new ProvinsiModel;
		// 	$data = [
		// 		'nama' => $provinsi
		// 	];
		// 	$provModel->insert($data);
		// 	foreach($kotas as $kota){
		// 		$kotaModel = new KotaModel;
		// 		$prov = $provModel->where('nama',$provinsi)->first();
		// 		$data = [
		// 			'provinsi' => $prov['id'],
		// 			'nama' => $kota
		// 		];
		// 		$kotaModel->insert($data);
		// 	}
		// }
	}
	function getkota(){
