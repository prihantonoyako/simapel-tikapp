			...
			this.each(function() {
				...
				h.hover) {
					...
					g.bind("click." + g.attr("id"), function(b) {
						...
						a(document).unbind("click." + i.attr("id"))) : (b.preventDefault(),
						e()),
						i.hasClass("active") && a(document).bind("click." + i.attr("id"), function(b) {
							i.is(b.target) || g.is(b.target) || g.find(b.target).length || (f(),
			...
			return this.each(function() {
				...
				if (!a(this).hasClass("initialized")) {
					...
					i.on("click", function() {
						...
						c = void 0,
						d = h[0].parentNode; null !== d && !a(d).is(document); ) {
							var n = a(d);
			...
			init: function() {
				return this.each(function() {
					...
					h >= g) {
						...
						k.className = "scrollbar-measure",
						document.body.appendChild(k);
						var l = k.offsetHeight - k.clientHeight;
						document.body.removeChild(k),
						0 === l && (l = 15,
						b.find(".indicator").css("bottom", l)),
					...
					"mouseenter.tooltip": function(a) {
						...
						f = setInterval(function() {
							...
							d >= h && e === !1) {
								...
								"top" === n ? (a = i.offset().top - o - g,
								c = i.offset().left + j / 2 - p / 2,
								f = b(c, a, p, o),
								q = "-10px",
								l.css({
								...
								l.css({
									...
									marginTop: o / 2,
									marginLeft: p
								})) : "right" === n ? (a = i.offset().top + m / 2 - o / 2,
								c = i.offset().left + j + g,
								f = b(c, a, p, o),
								r = "+10px",
								l.css({
									...
									marginTop: o / 2,
									marginLeft: "0px"
								})) : (a = i.offset().top + i.outerHeight() + g,
								c = i.offset().left + j / 2 - p / 2,
								f = b(c, a, p, o),
								q = "+10px",
								l.css({
				...
				if (!d.hasClass("browser-default")) {
					...
					j.find("li").each(function(f) {
						...
						a(this).click(function(d) {
							...
							c(l, a(this).index(), g),
							p.trigger("focus")) : (j.find("li").removeClass("active"),
							a(this).toggleClass("active"),
							g.siblings("input.select-dropdown").val(a(this).text())),
							activateOption(j, a(this)),
					...
					p.before(n),
					a("body").append(j),
					d.is(":disabled") || p.dropdown({
						hover: !1,
						closeOnClick: !1
					}),
					d.attr("tabindex") && a(p[0]).attr("tabindex", d.attr("tabindex")),
					d.addClass("initialized"),
					p.on({
						focus: function() {
							j.is(":visible") || a(this).trigger("open"),
							a("ul.select-dropdown").not(j[0]).is(":visible") && a("input.select-dropdown").trigger("close")
						},
						click: function(a) {
							a.stopPropagation()
						}
					...
					var q = []
					  , r = function(b) {
						...
						if (13 != b.which || j.is(":visible")) {
							...
							activateOption(j, g)),
							27 == b.which && p.trigger("close"),
							38 == b.which && (g = j.find("li.selected").prev("li:not(.disabled)")[0],
							g && activateOption(j, g)),
							setTimeout(function() {
								q = []
							}, 1e3)
